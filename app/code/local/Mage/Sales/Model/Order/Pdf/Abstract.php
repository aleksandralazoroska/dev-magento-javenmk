...
*/
    ...
    protected function insertTotals($page, $source){
        ...
        // Custom fields
        $this->y -= 70;
        $page->drawText(Mage::helper('sales')->__('Аuthorized person'), 40, $this->y, 'UTF-8');
        $page->drawText(Mage::helper('sales')->__('Chief Executive'), 500, $this->y, 'UTF-8');

        $this->y -= 30;
        $page->drawText(Mage::helper('sales')->__('___________________'), 30, $this->y, 'UTF-8');
        $page->drawText(Mage::helper('sales')->__('___________________'), 480, $this->y, 'UTF-8');

        $this->y -= 50;
        $page->drawText(Mage::helper('sales')->__('Thank you for your trust.'), 240, $this->y, 'UTF-8');

        $this->y -= 20;
        $page->drawText(Mage::helper('sales')->__('Complaints are received within 5 days.'), 216, $this->y, 'UTF-8');

        $this->y -= 20;
        $page->drawText(Mage::helper('sales')->__('In the event of a dispute, the Basic Court Bitola is competent.'), 191, $this->y, 'UTF-8');
